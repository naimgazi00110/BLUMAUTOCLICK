...
async def main():
    init()
    banner = f"""{Fore.GREEN}
  ______   __ _        _    _   _ ___   _   _    _    ___ __  __ 
 / ___\ \ / // \      / \  | \ | |_ _| | \ | |  / \  |_ _|  \/  |
| |  _ \ V // _ \    / _ \ |  \| || |  |  \| | / _ \  | || |\/| |
| |_| | | |/ ___ \  / ___ \| |\  || |  | |\  |/ ___ \ | || |  | |
 \____| |_/_/   \_\/_/   \_\_| \_|___| |_| \_/_/   \_\___|_|  |_|
                                                                
    Auto Claim Bot For Blum - NaimGazi Drop Automation
    Author  : NaimGazi : Thanks to @BLUMSCRIPTS
